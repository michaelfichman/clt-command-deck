...
const CACHE = 'clt-deck-v29';
const SHELL = ['./index.html', './lm-view.js', './lm-view.css', './lm-engine.js', './lm-gamify.js', './manifest.json', './icon-192.png', './icon-512.png', './apple-touch-icon.png'];
