...
function lmReachPanel(M,lens){const L=M.lenses[lens];const rc=L.reached&&L.reached.reach;if(!rc)return '';const pct=(n,d)=>d?Math.round(n/d*100)+'%':'—';let h='<div class="lm-qh">Three reach measures · each labeled by its denominator · diagnostic, not a competition</div><div class="lm-reach card">';
h+='<div class="lm-reach-row"><span><b>A. Lead response</b> — of '+rc.newLeads+' new leads</span><b>touched '+rc.touched+' ('+pct(rc.touched,rc.newLeads)+') · reached '+rc.connected+' ('+pct(rc.connected,rc.newLeads)+')</b></div>';
h+='<div class="lm-reach-row"><span><b>B. Dialing efficiency</b> — of '+lmNum(rc.dials)+' dials</span><b>'+lmNum(rc.trueConnects)+' true connects ('+pct(rc.trueConnects,rc.dials)+')</b></div>';
h+='<div class="lm-reach-row"><span><b>C. Attempt→connect</b> — of '+rc.touched+' attempted leads</span><b>'+rc.connected+' reached ('+pct(rc.connected,rc.touched)+')</b></div>';
